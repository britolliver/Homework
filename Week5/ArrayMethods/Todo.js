...
let userNine = data.filter(user => user.userId === 9);
console.log(userNine);

// then find the number of user 9's incomplete tasks
let userNineIncompleteTasks = userNine.filter(user => user.completed === false);
console.log(userNineIncompleteTasks.length);
